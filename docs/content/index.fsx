...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The F# ProjectTemplate library can be <a href="https://nuget.org/packages/FSharp.Core.NextVersion.Shim">installed from NuGet</a>:
      <pre>PM> Install-Package FSharp.Core.NextVersion.Shim</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
...
*)
#r "FSharp.Core.NextVersion.Shim.dll"
open FSharp.Core.NextVersion.Shim
